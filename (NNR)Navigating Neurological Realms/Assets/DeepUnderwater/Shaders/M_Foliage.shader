...
Shader "M_Foliage"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D Material_Texture2D_3;
						 ...
						 ) : SV_Target
			{
				...
				float4 temp_cast_0 = (_Mat1_BaseColor).xxxx;
				...
				float3 break10 = UnpackNormalScale( tex2D( Material_Texture2D_0, uvMaterial_Texture2D_0 ), 1.0f );
				float4 appendResult13 = (float4(break10.x , ( break10.y * _Invert ) , break10.z , 0.0));
				
				float4 temp_cast_3 = (_Mat1_Roughness).xxxx;
				float2 uv_Mat1_RoughnessT = IN.ase_texcoord8.xy * _Mat1_RoughnessT_ST.xy + _Mat1_RoughnessT_ST.zw;
				...
				float2 uvMaterial_Texture2D_3 = IN.ase_texcoord8.xy * Material_Texture2D_3_ST.xy + Material_Texture2D_3_ST.zw;
				...
				float3 BaseColor = ( _Mat1_BaseColor * staticSwitch20 ).rgb;
				float3 Normal = appendResult13.xyz;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = staticSwitch24.r;
				float Occlusion = 1;
				float Alpha = staticSwitch14.r;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uvMaterial_Texture2D_3 = IN.ase_texcoord3.xy * Material_Texture2D_3_ST.xy + Material_Texture2D_3_ST.zw;
				float2 uvMaterial_Texture2D_1 = IN.ase_texcoord3.xy * Material_Texture2D_1_ST.xy + Material_Texture2D_1_ST.zw;
				float4 tex2DNode2 = tex2D( Material_Texture2D_1, uvMaterial_Texture2D_1 );
				float4 temp_cast_0 = (tex2DNode2.a).xxxx;
				#ifdef _USEALBEDOALPHA_ON
				float4 staticSwitch14 = temp_cast_0;
				#else
				float4 staticSwitch14 = tex2D( Material_Texture2D_3, uvMaterial_Texture2D_3 );
				#endif
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uvMaterial_Texture2D_3 = IN.ase_texcoord4.xy * Material_Texture2D_3_ST.xy + Material_Texture2D_3_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uvMaterial_Texture2D_3 = IN.ase_texcoord2.xy * Material_Texture2D_3_ST.xy + Material_Texture2D_3_ST.zw;
				float4 temp_cast_2 = (tex2DNode2.a).xxxx;
				#ifdef _USEALBEDOALPHA_ON
				float4 staticSwitch14 = temp_cast_2;
				#else
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uvMaterial_Texture2D_3 = IN.ase_texcoord5.xy * Material_Texture2D_3_ST.xy + Material_Texture2D_3_ST.zw;
				float2 uvMaterial_Texture2D_1 = IN.ase_texcoord5.xy * Material_Texture2D_1_ST.xy + Material_Texture2D_1_ST.zw;
				float4 tex2DNode2 = tex2D( Material_Texture2D_1, uvMaterial_Texture2D_1 );
				float4 temp_cast_1 = (tex2DNode2.a).xxxx;
				#ifdef _USEALBEDOALPHA_ON
				float4 staticSwitch14 = temp_cast_1;
				#else
				float4 staticSwitch14 = tex2D( Material_Texture2D_3, uvMaterial_Texture2D_3 );
				#endif
...
WireConnection;49;4;24;0
WireConnection;49;6;14;0
ASEEND*/
//CHKSM=A1169D6FF25E17B4D76A1BDC185E271446BD7425